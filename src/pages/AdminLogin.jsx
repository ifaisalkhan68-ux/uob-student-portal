  ...
  return (
    <div className="max-w-sm mx-auto px-5 py-16">
      <div className="text-center mb-8">
        <div className="w-12 h-12 rounded-full seal-ring bg-green flex items-center justify-center mx-auto mb-4">
          <span className="text-brass-light font-serif font-bold">UB</span>
        </div>
